...
class ProductManagementProducerCreateProductTest {
    ...
    void shouldCreateProduct() {
        Optional<Long> actual = producer.create(new ProductDto("Water", "SomethingToDrink", BigDecimal.valueOf(123.45), 111L));
    ...
    void shouldNotCreateProductWhenItAlreadyExists() {
        Optional<Long> actual = producer.create(new ProductDto("Coffee", "Something to drink", BigDecimal.valueOf(123.45), 13L));
    ...
    void shouldNotCreateProductWhenShopDoesNotExist() {
        Optional<Long> actual = producer.create(new ProductDto("Coffee", "Something to drink", BigDecimal.valueOf(123.45), 7L));
